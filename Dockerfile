...
WORKDIR /pelesdin-clip

# Copy the src directory and pom.xml file
COPY pelesdin-clip/src ./src
COPY pelesdin-clip/pom.xml .
...
ENTRYPOINT ["java", "-cp", "target/classes:target/dependency/*", "ch.zhaw.deeplearningjava.pelesdinclip.App"]
